...
public class CommonNativeWrappers {
    ...
    public boolean launchApp(String platformName, String udid, String appPackage, String appActivity,
        ...
        try {
            ...
            if (platformName.equalsIgnoreCase("android")) {
                ...
                if (!appPackage.isEmpty()) dc.setCapability("appium:appPackage", appPackage);
                if (!appActivity.isEmpty()) dc.setCapability("appium:appActivity", appActivity);
                if (!chromeDriverPort.isEmpty()) dc.setCapability("appium:chromedriverPort", chromeDriverPort);
     ...
     *
     * @param appPath Relative path to application file from project root
